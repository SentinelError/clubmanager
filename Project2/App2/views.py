...
def register_request(request):
	...
	form = NewUserForm()
	Sform = StudentForm()
	return render (request=request, template_name="App2/register.html", context={"register_form":form, "Student":Sform})
...
def logout_request(request):
	...
	return render(request=request, template_name='App2/logout.html')
